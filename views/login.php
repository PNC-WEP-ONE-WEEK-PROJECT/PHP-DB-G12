...
<div class="flex p-20 mt-10">
    ...
    <div class=" w-full">
        <form action="" method="post" class="bg-gray-200 p-10 max-w-md text-center m-auto rounded-md">
            ...
            <br>
            <a href="register.php" class="bg-green-600 text-white p-2 rounded-md w-full">Create New Account</a>
        </form>
    </div>
</div>
