...
<body class="bg-slate-300 mt-28">
    <div class="rounded-lg mt-5 block m-auto w-3/5 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3">
        <form class="rounded-lg bg-slate-100 p-10 w-full h-1/3 top-10 left-5 flex items-center space-x-6">
            <div class="shrink-0">
                <img class="h-20 w-20 object-cover rounded-full" src="/images/<?=$user_info['profile']?>" alt="Current profile photo" />
            </div>
